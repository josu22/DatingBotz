...
class Geomatch:
    ...
    def __init__(self, name, age, work, study, home, gender, bio, lifestyle, basics, anthem, looking_for = None, distance = None, passions = None, image_urls = None, instagram = None, genders = None):
        self.name = name
        self.age = age
        self.work = work
        self.study = study
        self.home = home
        self.gender = gender
        self.genders = genders if genders is not None else ([gender] if gender else [])
    ...
    def get_genders(self):
        """Lista de géneros (varios en double-date)."""
        return self.genders
